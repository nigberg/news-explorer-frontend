  ...
  return (
    ...
    >
      ...
      <input
        ...
        minLength='3'
      />
      <span className={`form__error name__error ${errors.name && 'form__error_visible'}`}>Invalid username</span>
      <span className={`form__error form__error_common ${isCommonError && 'form__error_visible'}`}>This email is unavailable</span>
    </PopupWithForm>
  )
}
